...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-slate-950/98 backdrop-blur-xl p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 border-slate-800",
  {
    variants: {
      side: {
